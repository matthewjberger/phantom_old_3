use crate::backend::opengl::{buffer::GeometryBuffer, shader::ShaderProgram, texture::Texture};
...
use phantom_world::{
    AlphaMode, Format, LightKind, Material, MeshRender, RigidBody, Transform, World,
};
use std::{ptr, str};
                                    ...
                                    for primitive in mesh.primitives.iter() {
                                        ...
                                        .enumerate()
                                        {
                                            let texture_index = match *descriptor {
                                                ...
                                                _ => {
                                                    // TODO: Error out here
                                                    // bail!("Failed to find index for texture type!")
                                            ...
                                            if has_texture {
                                                self.textures[texture_index as usize]
                                                    .bind(index as _);
                                            }
                                        }
