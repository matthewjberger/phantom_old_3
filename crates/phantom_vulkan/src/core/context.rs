...
impl Context {
    ...
    fn instance_extensions(display_handle: &impl HasRawDisplayHandle) -> Result<Vec<*const i8>> {
        let mut extensions =
            enumerate_required_extensions(display_handle.raw_display_handle())?.to_vec();
